...
public class EntityMergeHandler extends BaseHandler {
    ...
    public Model handle(SMO smo, Model model) throws InputParameterException {
        if (containParameters(smo, Arrays.asList(ChangeOperatorParameter.FIRST_ENTITY_TO_MERGE, ChangeOperatorParameter.SECOND_ENTITY_TO_MERGE, ChangeOperatorParameter.NEW_ENTITY_NAME))) {
            ...
            WorkingSet firstWs = typhonQLInterface.selectEntityData(firstNewEntity.getName(), firstNewEntity.getAttributes().keySet(),null,  null, null);
            WorkingSet secondWs = typhonQLInterface.selectEntityData(secondNewEntity.getName(), secondNewEntity.getAttributes().keySet(),null,  null, null);
